...
/****** Object:  Database [STG]    Script Date: 28/02/2024 14:17:45 ******/
DROP DATABASE [STG]
GO
...
CREATE DATABASE [STG]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'STG', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL16.MSSQLSERVER\MSSQL\DATA\STG.mdf' , SIZE = 204800KB , MAXSIZE = UNLIMITED, FILEGROWTH = 65536KB )
 LOG ON 
( NAME = N'STG_log', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL16.MSSQLSERVER\MSSQL\DATA\STG_log.ldf' , SIZE = 401408KB , MAXSIZE = 2048GB , FILEGROWTH = 65536KB )
